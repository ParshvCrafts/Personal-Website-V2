...
**NEXT: P16** — wire the frames into the pinned `ScrollSequence` showpiece: per-theme grade dir (`dark` for midnight/neon, `light` for daylight/manuscript), `framePath="/sequences/intelligence/<grade>/frame_"`, `frameCount:120`, `pad:4`, keep DOM textBeats. See [[portfolio-v2-project]], [[working-style]], [[reviewer-subagents-readonly]].
